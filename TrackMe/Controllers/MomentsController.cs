...
namespace TrackMe.Controllers
{
    public class MomentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Feeling,FeelStrength,Being,With,Doing,Temp,Weather,Comments")] Moment moment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Feeling,FeelStrength,Being,With,Doing,Temp,Weather,Comments")] Moment moment)
        {
            if (ModelState.IsValid)
            {
